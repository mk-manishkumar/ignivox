...
export const allProducts = [
  {
    ...
    description: "Learn to build modern full stack applications with Next.js 16.",
  ...
  },
  {
    ...
    description: "Create stunning code screenshots with customizable themes, syntax highlighting, and export options. Perfect for documentation and social media.",
  ...
  },
  {
    ...
    description: "Boost your website conversions with real-time social proof notifications. Show recent purchases, sign-ups, and user activity to build trust and credibility.",
  ...
  },
  {
    ...
    description: "Maximize your global revenue with intelligent price localization. Automatically adjust pricing based on purchasing power parity to increase conversions worldwide.",
  ...
  },
  {
    ...
    description: "Create interactive charts, graphs, and dashboards from any data source. Perfect for presentations, reports, and data analysis.",
  ...
  },
  {
    ...
    description: "Design, send, and track beautiful email campaigns with our intuitive drag-and-drop editor and powerful automation tools.",
  ...
  },
  {
    ...
    description: "Centralized API management platform with real-time monitoring, documentation, and testing tools. Keep all your APIs organized and secure.",
  ...
  },
  {
    ...
    description: "Learn to lead a team of developers and become a leader in your field. This course is designed for developers who want to take the next step in their career and become a leader in their field.",
    websiteUrl: "https://developertoleader.com",
    tags: ["Leadership", "Management", "Development"],
    createdAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
    approvedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
    status: "pending" as const,
    submittedBy: "manish.kumar@gmail.com",
    voteCount: 340,
  },
];
